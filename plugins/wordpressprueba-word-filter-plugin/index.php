...
/*
    Plugin Name: Wordpress prueba word filter plugin
...
<?php } else { ?>
<div class="error">
    <p>Sorry, you do not have permission to do that action.</p>
</div>
<?php }
...
<div class="wrap">
    <h1>Word Filter</h1>
    <?php if (isset($_POST['justsubmitted']) == "true") echo $this->handleForm() ?>
    <form method="POST">
