...
//require_once get_template_directory() . '/api-keys.php';
...
function university_files() {
    ...
    //wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key='.$api_key, NULL, '1.0', true);
...
// Redireccionar cuentas creadas al homepage
...
// No mostrar barra de wordpress en usuarios suscritos
...
// Personalizar pantalla de inicio sesión
...
// Importar css en ventana de login
